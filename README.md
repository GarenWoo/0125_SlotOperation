...
`owner`为本合约第一个声明的状态变量，且继承的父合约可被继承的属性为 0 个。因此，`owner`的 slot 位置是 0 。

```solidity
    /**
     * @dev This function is used to change the owner of this contract by modifying value of corresponding slot.
     */
    ...
    /**
     * @dev This function is used to get the owner of this contract by modifying value of corresponding slot.
     */
 ...
 * @author Garen Woo
 */
contract NFTMarket_V2_2 is IERC721Receiver {
...
**合约已部署**：https://mumbai.polygonscan.com/address/0x820B8250AF97656F2be4CBc0f0B44360ec963e19
